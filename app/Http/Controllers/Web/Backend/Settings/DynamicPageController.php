...
class DynamicPageController extends Controller {
    ...
    public function termsAndConditions()
    {
        try {
            ...
            $data = DynamicPage::where('page_slug', 'terms-and-conditions')->get();

            if (!$data) {
                return $this->success([], 'Terms and Conditions data not found.', 200);
            }

            return $this->success($data, 'Terms and Conditions data retrieved successfully.', 200);
        } catch (Exception $e) {
